...
import { HalomotButton } from "@/components/ui/project-showcase-utils/halomot-button";
      ...
      >
        {isRTL && !isMobileView ? (
          <>
            ...
            <div className="flex justify-between flex-col py-4 w-full pointer-events-auto">
              <motion.div
                key={active}
  ...
  return (
    <div
      ...
      style={{
        ...
        padding: "2px",
        backgroundColor: isHovered ? hoverOutlineColor : outlineColor,
